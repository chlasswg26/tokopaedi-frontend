        ...
        <div className="container mb-5">
            <div className="row gx-4 mb-5">
                ...
                <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-8 col-xxl-8">
                  ...
                  <div className="hstack gap-5 align-items-end mb-5">
                    <Popout />
                  ...
                  <div className="hstack gap-4 align-items-end">
                    <button className="btn btn-add-bag">Add bag</button>
                    <button className="btn btn-buying">Buy</button>
                  </div>
                </div>
            </div>
